...
\begin{document}
  ...
  En cambio, las tareas y actividades que realizan los usuarios potenciales son múltiples. Muchos de ellos consultan el periódico en su smartphone a través de aplicaciones, pìden comida a domicilio,  realizan compras en Amazon, Aliexpress, etc., utilizan redes sociales como Facebook, Instagram, Twitter y/o aplicaciones de mensajería instantánea como, por ejemplo, WhatsApp, etc. En definitiva, usan el smartphone para facilitar su día a día tanto como para trabajo, ocio, informarse de noticias, escuchar música, reproducir vídeos y entretener a sus posibles hijos con aplicaciones para niños.
  ...
  \begin{center}
    ...
    \begin{tabular}{|p{2cm}|p{2cm}|p{1cm}|p{6cm}|}
      \hline
      \textbf{ID} & RF-08 & \textbf{Título} & Valoraciones \\
      \hline
      \textbf{Prioridad} & Media & \textbf{Tipo} & Requisitos de Usabilidad y Experiencia de Usuario \\
      \hline
    ...
    \begin{tabular}{|p{2cm}|p{2cm}|p{1cm}|p{6cm}|}
      ...
      \hline
      \textbf{Prioridad} & Media & \textbf{Tipo} & Requisito Funcional de Datos \\
      \hline
      \textbf{Descripción} & \multicolumn{3}{|p{9cm}|}{La aplicación deberá permitir a los usuarios reducir los elememntos de la búsqueda a través de filtros por etiquetas y por nombre.} \\
      \hline
    \end{tabular}
  ...
  \begin{center}
    ...
    \begin{tabular}{|p{2cm}|p{2cm}|p{1cm}|p{6cm}|}
      \hline
      \textbf{ID} & RNF-05 & \textbf{Título} & Moneda Virtual \\
      \hline
      \textbf{Prioridad} & Media & \textbf{Tipo} & Requisitos de Usabilidad y Experiencia de Usuario \\
      \hline
      \textbf{Descripción} & \multicolumn{3}{|p{9cm}|}{Los usuarios podrán obtener \textit{H3lp Coins} por la realización de diferentes acciones.} \\
      \hline
    \end{tabular}
    ...
    \begin{tabular}{|p{2cm}|p{2cm}|p{1cm}|p{6cm}|}
      \hline
      \textbf{ID} & RNF-06 & \textbf{Título} & Niveles \\
      \hline
      \textbf{Prioridad} & Media & \textbf{Tipo} & Requisitos de Usabilidad y Experiencia de Usuario \\
      \hline
      \textbf{Descripción} & \multicolumn{3}{|p{9cm}|}{Los usuarios registrados tendrán un nivel que irá aumentando con la realización de acciones.} \\
      \hline
    \end{tabular}
