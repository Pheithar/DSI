...
\fancypagestyle{doc}{
  %Cabecera
  \headerpr[1]{Análisis y Estudio de Campo}{\textbf{H3lp Me}}{Diseño de Sistemas Interactivos}
  %Pie de Página
...
\begin{document}
  ...
  \centeredtitle{Images/logo_help.png}{Grado en Ingeniería Informática}{Curso 2020}{Diseño de Sistemas Interactivos}{Análisis y Estudio de Campo: H3lp Me}
  ...
  \textbf{H3lp Me} es una aplicación web a través la cual los usuarios pueden pedir ayuda a otros en cualquier ámbito de la vida cotidiana o profesional, como puede ser un servicio de comida, resolver un problema informático, o cualquier incidente que pueda surgir en el día a día.
  ...
  Para establecer un contexto y estado del arte apropiados hemos decidido elegir 4 aplicaciones y sitios web que implementan parcialmente las funciones de nuestro software. Estas son \textbf{Wallapop}, que ofrece un servicio de compra venta entre usuarios sin intermediarios; \textbf{JustEat}, un servicio que actua de intermediario entre restaurantes y usuarios para ofrecer comida a domicilio; \textbf{Milanuncios}, un sitio web que ofrece una amplia de servicios y productos en diferentes areas, siendo esta web la que más se asimila a nuestro software; y \textbf{Fiverr}, un sitio que ofrece servicios \textit{freelance} online.
    ...
    \subsubsection{Wallapop}
      ...
      \begin{itemize}
        ...
        \item \textbf{Los vendedores son particulares o profesionales}:
        ...
        \item \textbf{Envíos a través de la aplicación}:
          Wallapop tiene un convenio con Correos y cuenta con un servicio de envíos a través de la aplicación para evitar estafas.
        \item \textbf{Valoraciones}:
          Cuando se vende un producto, el vendedor puede recibir una valoración por parte del comprador.
    ...
    Algunas de las características que tiene JustEat son:
      ...
      \begin{itemize}
        \item \textbf{Busqueda por cercania}:
          Para realizar una busqueda lo primero que debes introducir es una dirección y te muestre los restaurantes más cercanos que hay en tu zona.
        \item \textbf{Enfocado a comida a domicilio}:
    ...
    Algunas de las características con la que cuenta Milanuncios son:
      ...
      \begin{itemize}
        \item \textbf{Chat integrado}:
        La aplicación cuenta con un chat que permite a los usuarios interesados en un producto contactar con un vendedor.
        \item \textbf{Búsqueda por cercania}:
        La aplicación utiliza la geolocalización del usuario para realizar un filtro por cercanía.
        \item \textbf{Enfocado al mercado de segunda mano, empleo}:
        La aplicación fomenta el mercado de segunda mano entre particulares, sin dejar de lado a los profesionales.
        \item \textbf{Valoraciones}:
        La aplicación cuenta con un sistema de valoraciones que permite a los usuarios puntuar su experiencia con un vendedor.
    ...
    \begin{itemize}
      \item \textbf{Chat integrado}:
      La aplicación cuenta con un chat que permite a los usuarios que contratan un servicio comunicarse con la persona que lo ofrece.
      \item \textbf{Búsqueda por cercania}:
      La aplicación utiliza la geolocalización del usuario para realizar un filtro por cercanía.
      \item \textbf{Enfocado a los servicios freelance}:
      La aplicación fomenta el ofrecimiento de servicios por parte de particulares o pequeñas empresas.
      \item \textbf{Ayuda online en diferentes áreas}:
      La aplicación apoya a los usuarios con una documentación y tutorial.
      \item \textbf{Valoraciones}:
      La aplicación cuenta con un sistema de valoraciones que permite a los usuarios puntuar el servicio y su experiencia en él.
  ...
  En general, las 4 aplicaciones web contienen elementos o diseños a tener en cuenta para el desarrollo de la página. Ahora se pasará a analizar uno por uno los puntos positivos en los que se basará el proyecto:

  \subsubsection{Wallapop}

    De \textit{Wallapop}, interesa especialmente el serivicio de mensajería directa entre cliente y proveedor. Se considera que es una manera rápida y sin intermediarios de acordar un trabajo o un servicio con todos sus parámetros.
    Este tipo de trato será la base de \textit{H3lp Me}, donde los usuarios podrán comunicarse entre ellos para no tener ninguna duda sobre el servicio que están solicitando.

  \subsubsection{JustEat}

    \textit{JustEat} es una página que actua como intermediario entre restaurantes y los clientes. En el proyecto se desea adaptar esto para poder servir como plataforma para que gente dispuesta a ofrecer sus servicios encuentre a gente que los necesite, con un sistema de valoración como el que cuenta \textit{JustEat}.

  \subsubsection{Milanuncios}

    \textit{Milanuncios} tiene una característica principal, y esa es la gran cantidad de áreas que abarca, pudiendo colgar anuncios personalizados por cada usuario. En \textit{H3lp Me} se busca que cualquier servicio legal pueda ser ofertado, tanto por profesionales, como por particulares, siempre con unos parámetros y precios acordes al trabajo y la calidad del mismo, previamente establecido entre cliente y proveedor.

  \subsubsection{Fiverr}

    \textit{Fiverr} es la aplicación que más se parece al diseño que se plantea, ya que ofrece servicios online de \textit{freelances}. Se quiere adaptar esto al proyecto, de tal forma que tanto \textit{freelances} como profesionales, como gente interesada pueda ofrecer y solicitar servicios puntuales o termporales de manera rápida y sencilla.

  \subsection{Cuestionario}

  Antes de realizar el análisis, se ha decidido eliminar las respuestas que se consideraban inútiles para el análisis, como las respuestas donde se puede ver que los datos introducidas no son reales, además de eliminar todas las respuestas que respondieron negativamente a la última pregunta, ya que eso indica que la persona que respondió no es un usuario potencial de la aplicación.
  ...
  \begin{center}
    ...
    \begin{tabular}{|p{2cm}|p{2cm}|p{1cm}|p{6cm}|}
      ...
      \textbf{Prioridad} & Alta & \textbf{Tipo} & Requisito No Funcional Ambiental \\
      \hline
      \textbf{Descripción} & \multicolumn{3}{|p{9cm}|}{La aplicación deberá poder ejecutarse en los siguientes navegadores web: \textit{Mozilla Firefox v74.0.1 }, \textit{Google Chrome v79.0.3945.88} y \textit{Safari v13.0}.} \\
      \hline
    \end{tabular}
