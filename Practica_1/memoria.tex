...
\begin{document}
  ...
  En general, las 4 aplicaciones web contienen elementos o diseños a tener en cuenta para el desarrollo de nuestra página. Ahora pasaremos a analizar una por una los puntos positivos en los que nos basaremos en nuestro proyecto:

  \subsubsection{Wallapop}

    De Wallapop, nos interesa especialmente el serivicio de mensajería directa entre cliente y proveedor. Consideramos que es una manera rápida y sin intermediarios de acordar un trabajo o un servicio con todos sus parámetros.
    Este tipo de trato será la base de H3lp Me, donde los usuarios podrán comunicarse entre ellos para no tener ninguna duda sobre el servicio que están solicitando.

  \subsubsection{Just Eat}

    Just Eat, como hemos dicho, es una página que actua como intermediario entre restaurantes y los clientes. En nuestro caso queremos adaptar esto para poder servir como plataforma para que gente dispuesta a ofrecer sus servicios encuentre a gente que los necesite, con un sistema de valoración como el que cuenta Just Eat.

  \subsubsection{Milanuncios}

    MilAnuncios tiene una característica principal, y esa es la gran cantidad de áreas que abarca, pudiendo colgar anuncios personalizados por cada usuario. En H3lp Me queremos que cualquier servicio legal pueda ser ofertado, tanto por profesionales, como por gente que quiera ofrecerlo, siempre con unos parámetros y precios acordes al trabajo y la calidad del mismo, previamente establecido entre cliente y proveedor.

  \subsubsection{Fiverr}

    Fiverr es la aplicación que más se parece al diseño que planteamos, ya que ofrece servicios online de \textit{freelances}. Nosotros queremos adaptar esto a nuestro proyecto, de tal forma que tanto \textit{freelances} como profesionales, como gente interesada pueda ofrecer y solicitar servicios puntuales o termporales de manera rápida y sencilla.
