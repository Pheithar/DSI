...
\begin{document}
  ...
  En la segunda imagen del prototipo se puede apreciar la pagina una vez iniciada la sesión. La cabecera cambia en la parte derecha para pasar a mostrar un botón para cerrar sesión y un botón de acceso al perfil y ajustes.

  \vspace{2mm}

  En el cuerpo de la página se encuentra un apartado para los servicios ofrecidos por el usuario con un botón para poder añadir más. En cada uno de estos servicios se ve una imagen representativa y un titulo, además de un botón para poder ver más información sobre el servicio.
