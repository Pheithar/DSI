...
\begin{document}
  ...
  Este es el wireframe de la página de inicio, desde donde el usuario puede registrarse, iniciar sesión y ver la información general de H3lp Me, así como el video introductorio.

  \imgcenter[110]{Images/iniciosesionhelpme.png}

  El usuario inicia sesión con su nombre y contraseña.

  \imgcenter[110]{Images/cuid.png}

  Esta es la página principal donde aparecerán los servicios, desde ella, pueden aplicarse diferentes filtros para acceder a servicios concretos o buscar los servicios de interés.

  \imgcenter[110]{Images/serviciosinmenu.png}

  Este es un ejemplo del formato de un servicio. El usuario puedde contratarlo o ir a un chat con la persona que lo ofrece, por si quiere consultar dudas del mismo.

  \imgcenter[110]{Images/contratopop.png}

  Se muestra una alerta al usuario de que va a contratar un servicio, es una buena manera hacer ver al usuario el resultado de sus acciones.

  \imgcenter[110]{Images/contratado.png}

  Muestra una alerta al usuario de que se ha contratado el servicio.

  \imgcenter[110]{Images/ajustes.png}

  Se muestra un menú donde el usuario puede realizar ajustes sobre su cuenta en la plataforma como cambios en el nombre contraseña, cerrar sesión, etc. Además este menú sigue un diseño minimalista y concuerda con la página.

  \imgcenter[110]{Images/tienda.png}

  Esta es la sección de tienda donde el usuario puede promocionar sus productos.

  \imgcenter[110]{Images/perfildsi.png}

  En este wireframe, se muestra el perfil del usuario. Se incorpora el manú que se ha explicado con anterioridad para acceder a las diversas secciones.

  \imgcenter[110]{Images/chats.png}

  Esta es la sección de chats donde el usuario puede iniciar chats con sus solicitantes o con otros usuarios que ofrecen servicios.
