...
\begin{document}
  ...
  \begin{itemize}
    ...
    \item \textbf{Electron}: Se usa para generar aplicaciones de escritorio para los sistemas operativos Linux, Windows y MacOS.
  \end{itemize}

  El resultado final es una página web y aplicación de escritorio con acceso a base de datos y a imágenes de esta base de datos.

  \section{Manual de Uso}

  Nuestra aplicación H3lp Me está enfocada a los navegadores web Firefox y Google Chrome. Es importante que para probar todas las funcionalidades se siga esta guía.

  \vspace{2mm}

  \imgcenter[140]{Images/HELPME(1).jpg}
  ...
  En la parte superior, tenemos un header con el logo de la aplicación que si lo pulsamos te lleva a esta página, a la derecha están los botones registrarse e iniciar sesión. Justo debajo hay una barra de navegación para buscar servicios que ofrezca la gente y unos filtros ya preestablecidos como puede ser fotografía, informática, cocina etc. De esta forma tanto los usuarios con sesión iniciada como los que no tienen cuenta creada o todavía no han iniciado sesión pueden realizar búsquedas a través de los servicios de la aplicación.
  ...
  Cuando un usuario se va a registrar, tiene que pulsar el botón de registrarse y aparecerá un popup en la pantalla. Se solicitarán los campos de nombre de usuario, contraseña, repetir contraseña y quiero ser el \textit{h3lper}. Es importante en este paso seleccionar la opción de Quiero ser h3lper y recordar el nombre y contraseña. Para poder rellenar estos campos se necesita llegar al mínimo de caracteres. Solo los usuarios que decidan ser \textit{h3lper} podrán publicitar sus servicios en la aplicación.

  \vspace{2mm}

  \imgcenter[140]{Images/HELPME(3).jpg}

  Inmediatamente cuando una persona se registre, irá directamente a su perfil en la aplicación en el podrá ver sus servicios solicitados, que inicialmente serán cero y una tienda donde puede seleccionar promociones premium para promocionar los anuncios.
  ...
  \imgcenter[140]{Images/HELPME(7).jpg}

  Como nos registramos como \textit{h3lper}, en nuestro perfil también aparecerá una sección llamada tus servicios ofrecidos. En ella saldrán los anuncios que el usuario publicita en nuestra aplicación. También encontramos un botón que nos permite añadir un nuevo servicio. Al pulsarlo se nos abrirá un popup donde nos solicitan los campos necesarios para publicar un anuncio tales como nombre del servicio, categoría, una descripción opcional, localización, precio y una imagen que tenga el usuario.

  \vspace{2mm}

  \imgcenter{Images/HELPME(8).jpg}

  Tras crear los anuncios, nos darán 30 puntos de experiencia por cada uno y nos aparece en la esquina superior derecha un número que simboliza las personas que han solicitado el servicio publicado. Para seguir el tutorial, será necesario crear dos servicios.

  \vspace{2mm}

  \imgcenter[140]{Images/HELPME(9).jpg}

  \imgcenter[140]{Images/HELPME(10).jpg}
  ...
  \imgcenter[140]{Images/HELPME(12).jpg}
  ...
  \imgcenter[140]{Images/HELPME(13).jpg}
  ...
  \imgcenter[140]{Images/HELPME(16).jpg}

  \imgcenter[140]{Images/HELPME(17).jpg}
  ...
  \imgcenter[140]{Images/HELPME(20).jpg}
  ...
  Para acceder a la aplicación de escritorio generada con electron será necesario acceder al siguiente repositorio de \textbf{GitHub}:

  \begin{center}
    \url{https://github.com/Pheithar/h3lp-me-electron-app}
  \end{center}

  En el repositorio se encuentran 3 archivos comprimidos. Será necesario descargar únicamente el que corresponde con tu sistema operativo.
