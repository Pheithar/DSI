...
\begin{document}
  ...
  \begin{enumerate}
    ...
    El fallo más recrrente en esta tarea es que intentaban promocionar el servicio dentro del mismo, porque no encontraban el menú de la tienda dentro de su perfil.
    ...
    Lo que menos les ha gustado a los usuarios es su atractivo visual, y la distirbución de los aprtados. Preferirían una división entre \textit{Servicios Solicitados},  \textit{Servicios Ofrecidos} y \textit{Tienda}, para no tener que hacer \textit{scroll} en la misma página.

    \item \textbf{Pregunta 9}

    Practicamente todos los usuarios están de acuerdo en que la página es muy fácil de usar y muy intuitiva. Además, algunos usuarios, en contraposición a la respuesta anterior, dicen que es bonita y que tiene un buen diseño estético.
